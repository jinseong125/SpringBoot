...
public class User {
  ...
  @Column(name = "phone_numbrt")
  private String phoneNumber;
  
  @Column(length = 100)  //----- vaechar
  private String address;
  
  @Column(columnDefinition = "text")
  private String memo;
  
  @CreationTimestamp  //----- 엔티티 정보가 테이블에 INSERT 될 때 자동으로 현재시간 출력
  ...
  public User(Long uid, String username, String email, String phoneNumber, String address, String memo,
      LocalDateTime created_At, UserGrade userGrade) {
    super();
    this.uid = uid;
  ...
  public String toString() {
    return "User [uid=" + uid + ", username=" + username + ", email=" + email + ", phoneNumber=" + phoneNumber
        + ", address=" + address + ", memo=" + memo + ", created_At=" + created_At + ", userGrade=" + userGrade + "]";
  }
